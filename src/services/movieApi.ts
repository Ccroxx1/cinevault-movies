...
export function validateAndCleanMovies(movies: any[]): Movie[] {
  ...
  for (const m of movies) {
    ...
    const large_screenshot_image1 = normalizeImageUrl(m.large_screenshot_image1);
    const large_screenshot_image2 = normalizeImageUrl(m.large_screenshot_image2);
    const large_screenshot_image3 = normalizeImageUrl(m.large_screenshot_image3);

    const medium_screenshot_image1 = normalizeImageUrl(m.medium_screenshot_image1);
    const medium_screenshot_image2 = normalizeImageUrl(m.medium_screenshot_image2);
    const medium_screenshot_image3 = normalizeImageUrl(m.medium_screenshot_image3);
