      ...
      try {
        const results = await Promise.allSettled(
          CURATED_SECTIONS.map(async (sec) => {
            ...
            // If specific query returned too few, supplement with fallbacks filtered by ALL section parameters
            ...
            // Ensure full filter consistency & sorting
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {route.type === 'movie' ? (
          ...
          <>
            ...
            {/* 1. Recently Inspected Titles (If history exists) */}
            ...
            {/* 3. Explore Films & Torrents (Catalog Search, Filter Bar & Grid) */}
            ...
            {/* 5. Curated Film Collections (Categorized Movie Sections) */}
            {currentNav === 'browse' && !filters.query_term && filters.page === 1 && filters.genre === 'All' && filters.quality === 'All' && (
            ...
            {/* 6. Curated Mood Playlists & Collections Bar */}
