...
export const MovieComparisonModal: React.FC<MovieComparisonModalProps> = ({
  ...
  return (
    ...
    >
      <div className="modal-dialog-surface relative w-full max-w-6xl rounded-2xl sm:rounded-3xl bg-[#0c0c0c] border border-white/15 shadow-2xl overflow-hidden flex flex-col max-h-[92vh]">
        {/* Header */}
