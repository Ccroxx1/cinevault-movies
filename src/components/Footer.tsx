...
export const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer id="cinevault-footer" className="w-full border-t border-white/10 bg-[#050505] mt-16 py-10 text-xs text-neutral-500" role="contentinfo">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <nav aria-label="Legal and Help Links" className="flex flex-wrap items-center justify-center md:justify-end gap-3 sm:gap-4 text-xs">
            ...
            <button
              ...
              className="hover:text-rose-400 transition-colors cursor-pointer text-rose-400/90 hover:text-rose-300"
            >
              Guides
            </button>
          </nav>
